...
from apps.tooling.agent import check_backend_boundaries as backend_audit
from apps.tooling.agent import check_frontend_boundaries as frontend_audit
...
class FrontendBoundaryAuditTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.web_src = self.root_dir / "apps" / "portal" / "web" / "src"
