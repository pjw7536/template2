...
"[project]/tailwind/src/lib/timezone.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TZ_NAME_PATTERN = /^[A-Za-z_]+(?:\/[A-Za-z_]+)*$/;
function normalizeDbTimeZone(value) {
    ...
    if (trimmed === "Z" || trimmed.toUpperCase() === "UTC" || trimmed === "+00:00") {
        return "UTC";
    }
    if (OFFSET_PATTERN.test(trimmed)) {
        return trimmed;
    }
    if (TZ_NAME_PATTERN.test(trimmed)) {
        return trimmed;
    }
    return "UTC";
}
const DB_TIME_ZONE = normalizeDbTimeZone(process.env.DB_TIMEZONE);
function getDbTimeZone() {
    return DB_TIME_ZONE;
}
function isDbTimeZoneUtc() {
    return DB_TIME_ZONE === "UTC";
}
function toUtcExpression(columnName) {
    const quotedColumn = `\`${columnName}\``;
    if (isDbTimeZoneUtc()) {
        return quotedColumn;
    }
    return `CONVERT_TZ(${quotedColumn}, '${DB_TIME_ZONE}', '+00:00')`;
}
function utcNowExpression() {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/tailwind/src/lib/db.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$src$2f$lib$2f$timezone$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/tailwind/src/lib/timezone.js [app-route] (ecmascript)");
...
async function GET(request) {
    ...
    try {
        ...
        const timestampUtcExpression = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$src$2f$lib$2f$timezone$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toUtcExpression"])(baseTsCol);
        const timestampUtcTarget = `(${timestampUtcExpression})`;
        const defaultCutoffCondition = `${timestampUtcTarget} >= (${(0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$src$2f$lib$2f$timezone$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["utcNowExpression"])()} - INTERVAL 36 HOUR)`;
        ...
        whereParts.push(defaultCutoffCondition);
        if (normalizedFrom) {
            params.push(`${normalizedFrom} 00:00:00`);
            whereParts.push(`${timestampUtcTarget} >= ?`);
        }
        if (normalizedTo) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad1d970a._.js.map