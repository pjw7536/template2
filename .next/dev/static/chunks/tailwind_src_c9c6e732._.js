...
function AppSidebar(t0) {
    ...
    if ($[0] !== "701d45d72be80b464136707871e8c1973107857eb235a7431fc3d2d2307fb901") {
        for(let $i = 0; $i < 19; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "701d45d72be80b464136707871e8c1973107857eb235a7431fc3d2d2307fb901";
    }
    let lineOptions;
    let props;
    if ($[1] !== t0) {
    ...
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$src$2f$features$2f$auth$2f$auth$2d$context$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(AppSidebar, "WQN1piNkMjaOM8k1F55whTN++Jc=", false, function() {
    return [
...
//# sourceMappingURL=tailwind_src_c9c6e732._.js.map