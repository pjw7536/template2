...
function useSidebar() {
    ...
    if ($[0] !== "ec2ec1c2d558261ef376d8e0a10564cfa343c4141ad47cd86d7b72351a7b83bd") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ec2ec1c2d558261ef376d8e0a10564cfa343c4141ad47cd86d7b72351a7b83bd";
    }
...
function NavMain(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "15322f68752b746db2aaa7a3504c76e3ce1a99769d71d3fd1ac3ee96197bab90") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "15322f68752b746db2aaa7a3504c76e3ce1a99769d71d3fd1ac3ee96197bab90";
    }
    const { items } = t0;
...
_s(NavMain, "+jVsTcECDRo3yq2d7EQxlN9Ixog=", false, function() {
    return [
...
function TeamSwitcher(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(43);
    if ($[0] !== "1b480cd0dea2935f11d6c4aa0d84c21590a9b419f84b17ea3d4c069db84e80e4") {
        for(let $i = 0; $i < 43; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1b480cd0dea2935f11d6c4aa0d84c21590a9b419f84b17ea3d4c069db84e80e4";
    }
    const { lines } = t0;
    const { isMobile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$src$2f$components$2f$ui$2f$sidebar$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSidebar"])();
    ...
    bb0: {
        ...
        let t2;
        if ($[2] !== lines) {
            t2 = lines.map(_TeamSwitcherLinesMap).filter(_TeamSwitcherAnonymous);
            $[2] = lines;
            $[3] = t2;
        } else {
            t2 = $[3];
    ...
    bb1: {
        ...
        if (Array.isArray(lineParam)) {
            t2 = lineParam[0];
            break bb1;
        }
        t2 = options[0]?.id ?? null;
    }
    const activeLineId = t2;
    let t3;
    if ($[4] !== activeLineId || $[5] !== options) {
        t3 = options.find({
    ...
    const activeLine = t3;
    let t4;
    if ($[7] !== activeLineId || $[8] !== lineParam || $[9] !== pathname || $[10] !== router) {
        t4 = ({
    ...
    let t5;
    if ($[12] !== activeLine.label) {
        t5 = getInitials(activeLine.label);
        $[12] = activeLine.label;
        $[13] = t5;
    } else {
        t5 = $[13];
    ...
    let t7;
    if ($[16] !== activeLine.label) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "truncate font-medium",
    ...
    let t8;
    if ($[18] !== activeLine.description) {
        t8 = activeLine.description ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    const t12 = isMobile ? "bottom" : "right";
    let t13;
    ...
    let t14;
    if ($[28] !== activeLineId || $[29] !== handleSelect || $[30] !== options) {
        let t15;
        if ($[32] !== activeLineId || $[33] !== handleSelect) {
            t15 = ({
...
const DEFAULT_TEAMS = [
    {
        id: "line-01",
        label: "LINE-01",
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$gallery$2d$vertical$2d$end$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__GalleryVerticalEnd$3e$__["GalleryVerticalEnd"],
        description: "Enterprise"
    },
    {
        id: "line-02",
        label: "LINE-02",
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$audio$2d$waveform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AudioWaveform$3e$__["AudioWaveform"],
        description: "Startup"
    },
    {
        id: "line-03",
        label: "LINE-03",
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$command$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Command$3e$__["Command"],
        description: "Free"
    }
];
...
function AppSidebar(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(14);
    if ($[0] !== "0292df2c31d39992337186a30058ed5021e69b2c12e894636fc9fd2c1dc01f2b") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0292df2c31d39992337186a30058ed5021e69b2c12e894636fc9fd2c1dc01f2b";
    }
    let lineOptions;
    let props;
    if ($[1] !== t0) {
    ...
    let t1;
    if ($[4] !== lineOptions) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$src$2f$features$2f$navigation$2f$config$2f$navigation$2d$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapLinesToNavigationOptions"])(lineOptions);
        $[4] = lineOptions;
        $[5] = t1;
    } else {
        t1 = $[5];
...
//# sourceMappingURL=tailwind_src_96357c57._.js.map