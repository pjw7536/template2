...
function NavMain(t0) {
    ...
    if ($[0] !== "5baba9e10612d83ba884bd4d052cca692c57b114fec91b80fdb986f7a65c3996") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5baba9e10612d83ba884bd4d052cca692c57b114fec91b80fdb986f7a65c3996";
    }
    const { items } = t0;
    let t1;
...
function AppSidebar(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tailwind$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "4f788a5b5b74c3b9325df324166774e7423fc48721df43d2fff11ceb32ee0faf") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4f788a5b5b74c3b9325df324166774e7423fc48721df43d2fff11ceb32ee0faf";
    }
    let props;
    if ($[1] !== t0) {
        ({ ...props } = t0);
...
//# sourceMappingURL=tailwind_src_f530e847._.js.map