# 03. FTP Kubernetes 원본과 수동 배포

[시작 안내](README.md) · [자동 배포](01_SERVER_SETUP.md)

기본 실행은 `make ftp-check` → `make ftp-up`입니다. 아래는 원본 구조와 수동 배포 참고입니다.
자동 배포와 수동 배포를 중복 실행할 필요는 없습니다.
