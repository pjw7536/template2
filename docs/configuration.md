...
3. Portal·Keycloak·MinIO·mock은 tailwind-local, Airflow·FTP·Monitoring은 앱별 namespace에 배포합니다.
...
- L3 Spider 데이터 경로 변경: `local/portal/env/api.env`, `deploy/portal/env/*/api.env`, `docker-compose*.yml`, `deploy/*/compose/*.yml`, `docs/api/l3-spider.md`, `docs/inventory.md`
