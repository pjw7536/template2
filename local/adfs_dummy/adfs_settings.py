...
RAG_INDEX_DEFAULT = os.getenv("RAG_INDEX_DEFAULT") or "rp-unclassified"
...
for name in [*RAG_INDEX_LIST, PRIMARY_RAG_INDEX, *EXTRA_RAG_INDEXES]:
    if name and name not in INDEX_NAMES:
        INDEX_NAMES.append(name)
if not INDEX_NAMES:
    INDEX_NAMES.append("emails")

MAILBOX_RAG_INDEX = RAG_INDEX_EMAILS or PRIMARY_RAG_INDEX or INDEX_NAMES[0]
